...
const Navbar = () => {
    ...
    const HandleLogout = async () => {
        const res = await axios.get("https://recipe-mernweb-app.onrender.com/api/logout", {
    ...
    const checkUser = async () => {
        const res = await axios.get("https://recipe-mernweb-app.onrender.com/api/checkUser", {
            withCredentials: true,
        });
        const data = await res.data;
        if (data.success) {
